...
<head>
	...
	<script language="javascript" type="text/javascript" src="<%=contextPath%>/resources/javascripts/datetimepicker.js"></script>
</head>
<body>
<jsp:include page="Header.jsp">
  <jsp:param name="pageName" value="Create Service Request"/>
</jsp:include>
<form:form name="createServiceRequestForm" id="createServiceRequestForm" method="post" action="createServiceRequest">
